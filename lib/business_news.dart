...
class SNews extends StatefulWidget {
  @override
  BusinessNewsState createState() => BusinessNewsState();
}

class BusinessNewsState extends State<SNews> {
  String? data;
  var news_length;
  ...
  void getData() async {
    http.Response response = await http.get(Uri.parse("https://inshorts.deta.dev/news?category=business"));
