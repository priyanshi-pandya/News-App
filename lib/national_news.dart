...
class NNews extends StatefulWidget {
  @override
  NationalNewsState createState() => NationalNewsState();
}

class NationalNewsState extends State<NNews> {
  String? data;
  var news_length;
  ...
  void getData() async {
    http.Response response = await http.get(Uri.parse("https://inshorts.deta.dev/news?category=national"));
