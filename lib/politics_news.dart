...
class PNews extends StatefulWidget {
  @override
  PoliticsNewsState createState() => PoliticsNewsState();
}

class PoliticsNewsState extends State<PNews> {
  String? data;
  var news_length;
  ...
  void getData() async {
    http.Response response = await http.get(Uri.parse("https://inshorts.deta.dev/news?category=politics"));
