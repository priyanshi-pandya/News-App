...
class WNews extends StatefulWidget {
  @override
  WorldNewsState createState() => WorldNewsState();
}

class WorldNewsState extends State<WNews> {
  String? data;
  var news_length;
  ...
  void getData() async {
    http.Response response = await http.get(Uri.parse("https://inshorts.deta.dev/news?category=world"));
